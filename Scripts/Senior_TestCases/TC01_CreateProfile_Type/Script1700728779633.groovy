...
WebUI.callTestCase(findTestCase('Common_TestCases/Senior_SignUp'), [('username') : UserName, ('email') : Email, ('zipcode') : ZipCode
...
WebUI.callTestCase(findTestCase('Senior_TestCases/TC06_SeniorDemographic'), [('UserName') : UserName, ('ZipCode') : ZipCode
        ...
        , ('birth_year') : birth_year, ('address_1') : address_1, ('address_2') : address_2, ('emergency_name') : emergency_name
        , ('emergency_address') : emergency_address, ('address_line2') : address_line2, ('emergency_zip_code') : emergency_zip_code
        , ('emergency_mobile_no') : emergency_mobile_no, ('emergency_other_no') : emergency_other_no], FailureHandling.STOP_ON_FAILURE)
