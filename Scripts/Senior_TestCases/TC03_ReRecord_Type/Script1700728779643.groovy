...
WebUI.callTestCase(findTestCase('Senior_TestCases/TC06_SeniorDemographic'), [('UserName') : '', ('Email') : Email, ('Profile') : Profile
        ...
        , ('address_1') : address_1, ('address_2') : address_2, ('zip_code') : zip_code, ('emergency_name') : emergency_name
