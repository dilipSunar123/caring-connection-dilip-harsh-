...
WebUI.callTestCase(findTestCase('Senior_TestCases/TC06_SeniorDemographic'), [('UserName') : '', ('Email') : Email, ('EducationNew') : EducationNew
        , ('FamilyAndCommunityNew') : FamilyAndCommunityNew, ('HobbiesNew') : HobbiesNew, ('ExpectationsNew') : ExpectationsNew
        , ('OtherNew') : OtherNew, ('mobile_no') : mobile_no, ('birth_year') : birth_year, ('address_1') : address_1, ('address_2') : address_2
        , ('zip_code') : zip_code, ('emergency_name') : emergency_name, ('emergency_address') : emergency_address, ('address_line2') : address_line2
        , ('emergency_zip_code') : emergency_zip_code, ('emergency_mobile_no') : emergency_mobile_no, ('emergency_other_no') : emergency_other_no], 
